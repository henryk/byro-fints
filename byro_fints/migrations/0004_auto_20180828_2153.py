    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fints_client_data', models.BinaryField(blank=True, null=True, verbose_name='Stored FinTS client data')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='login',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_login', to='byro_fints.FinTSLogin'),
        ),
        migrations.AddField(
            model_name='fintsuserlogin',
            name='user',
